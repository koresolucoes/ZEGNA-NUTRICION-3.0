...
export const ICONS: { [key: string]: React.ReactNode } = {
    ...
    star: <svg xmlns="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 2.28 2.28" baseProfile="full" enable-background="new 0 0 76.00 76.00" ><path fill="#000000" fill-opacity="1" stroke-linejoin="round" d="M1.607 1.71H0.679v-0.15l0.592 -0.778H0.728V0.57h0.879v0.146L1.028 1.498H1.607z"/></svg>,
