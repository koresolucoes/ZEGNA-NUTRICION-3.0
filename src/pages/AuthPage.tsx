...
export const ICONS: { [key: string]: React.ReactNode } = {
    ...
    clipboard: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect></svg>,
    ...
    star: <svg xmlns="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 2.28 2.28" baseProfile="full" enableBackground="new 0 0 76.00 76.00" ><path fill="#000000" fillOpacity="1" strokeLinejoin="round" d="M1.607 1.71H0.679v-0.15l0.592 -0.778H0.728V0.57h0.879v0.146L1.028 1.498H1.607z"/></svg>,
    sparkles: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3L9.5 8.5L4 11L9.5 13.5L12 19L14.5 13.5L20 11L14.5 8.5L12 3Z"/><path d="M3 21L5.5 15.5L11 13L5.5 10.5L3 5"/><path d="M21 21L18.5 15.5L13 13L18.5 10.5L21 5"/></svg>,
    ...
    healt: <svg width="24px" height="24px" viewBox="0 0 1.92 1.92" xmlns="http://www.w3.org/2000/svg"  aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet"><path fillRule="none" d="M1.412 0.873c-0.103 -0.168 -0.103 -0.45 -0.345 -0.478 0.023 -0.067 0.053 -0.2 -0.007 -0.331 -0.005 -0.01 -0.044 0.009 -0.041 0.02 -0.06 -0.018 -0.267 -0.068 -0.385 0.074C0.498 0.322 0.27 0.392 0.27 0.392c0.067 -0.012 0.134 -0.029 0.198 -0.055 0.064 -0.026 0.125 -0.06 0.183 -0.098 0.058 -0.037 0.117 -0.078 0.185 -0.107a0.57 0.57 0 0 1 0.102 -0.033A0.54 0.54 0 0 1 1.022 0.09l0 0.001c-0.061 0.009 -0.124 0.026 -0.181 0.054 -0.062 0.03 -0.118 0.069 -0.178 0.107 -0.059 0.038 -0.123 0.074 -0.192 0.098a0.81 0.81 0 0 1 -0.102 0.029A0.81 0.81 0 0 1 0.27 0.392s0.464 0.115 0.709 -0.123c0.039 -0.037 0.052 -0.089 0.056 -0.128 0.023 0.113 -0.005 0.204 -0.029 0.251 -0.264 0.013 -0.239 0.307 -0.344 0.48 -0.079 0.13 -0.237 0.306 -0.237 0.497C0.426 1.696 0.732 1.86 1.038 1.86 1.344 1.86 1.65 1.697 1.65 1.37c0 -0.191 -0.159 -0.367 -0.238 -0.497m0.047 0.747c-0.094 0.094 -0.251 0.15 -0.421 0.15 -0.252 0 -0.523 -0.125 -0.523 -0.401 0 -0.121 0.085 -0.244 0.16 -0.353 0.023 -0.034 0.045 -0.066 0.064 -0.097 0.038 -0.063 0.06 -0.134 0.082 -0.203 0.053 -0.17 0.084 -0.235 0.205 -0.235h0c0.126 0 0.164 0.072 0.227 0.248 0.023 0.065 0.047 0.131 0.083 0.19 0.019 0.031 0.041 0.062 0.064 0.096 0.075 0.109 0.161 0.233 0.161 0.354 0 0.099 -0.034 0.183 -0.101 0.25" fill="#000000"/></svg>,
    exercise: <svg width="24px" height="24px" viewBox="0 0 1.92 1.92" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"><defs><style>.fill:#231f20 ;</style></defs><title/><path  d="M0.35 1.121h-0.09a0.03 0.03 0 0 1 -0.03 -0.03v-0.262a0.03 0.03 0 0 1 0.03 -0.03h0.09a0.03 0.03 0 0 1 0.03 0.03v0.262a0.03 0.03 0 0 1 -0.03 0.03m-0.06 -0.06h0.03v-0.202h-0.03Z"/><path  d="M0.47 1.188h-0.12a0.03 0.03 0 0 1 -0.03 -0.03V0.762a0.03 0.03 0 0 1 0.03 -0.03h0.12a0.03 0.03 0 0 1 0.03 0.03v0.395a0.03 0.03 0 0 1 -0.03 0.03m-0.09 -0.06h0.06V0.792h-0.06Z"/><path  d="M0.67 1.26h-0.2a0.03 0.03 0 0 1 -0.03 -0.03V0.69a0.03 0.03 0 0 1 0.03 -0.03h0.2a0.03 0.03 0 0 1 0.03 0.03v0.54a0.03 0.03 0 0 1 -0.03 0.03m-0.17 -0.06h0.14V0.72h-0.14Z"/><path className="cls-1" d="M1.66 1.121h-0.09a0.03 0.03 0 0 1 -0.03 -0.03v-0.262a0.03 0.03 0 0 1 0.03 -0.03h0.09a0.03 0.03 0 0 1 0.03 0.03v0.262a0.03 0.03 0 0 1 -0.03 0.03m-0.06 -0.06h0.03v-0.202h-0.03Z"/><path  d="M1.57 1.188h-0.12a0.03 0.03 0 0 1 -0.03 -0.03V0.762a0.03 0.03 0 0 1 0.03 -0.03h0.12a0.03 0.03 0 0 1 0.03 0.03v0.395a0.03 0.03 0 0 1 -0.03 0.03m-0.09 -0.06h0.06V0.792h-0.06Z"/><path className="cls-1" d="M1.45 1.26h-0.2a0.03 0.03 0 0 1 -0.03 -0.03V0.69a0.03 0.03 0 0 1 0.03 -0.03h0.2a0.03 0.03 0 0 1 0.03 0.03v0.54a0.03 0.03 0 0 1 -0.03 0.03m-0.17 -0.06h0.14V0.72h-0.14Z"/><path  d="M1.25 1.05H0.67a0.03 0.03 0 0 1 -0.03 -0.03v-0.12a0.03 0.03 0 0 1 0.03 -0.03h0.581a0.03 0.03 0 0 1 0.03 0.03v0.12a0.03 0.03 0 0 1 -0.03 0.03m-0.55 -0.06h0.521v-0.06H0.7Z"/></svg> ,
    idea: <svg fill="#000000" width="24px" height="24px" viewBox="-0.12 0 0.57 0.57" xmlns="http://www.w3.org/2000/svg" ><path d="M0.31 0.205a0.177 0.177 0 0 1 -0.043 0.109 0.087 0.087 0 0 0 -0.018 0.03v0.031a0.028 0.028 0 0 1 -0.028 0.028h-0.111a0.028 0.028 0 0 1 -0.028 -0.028V0.344a0.087 0.087 0 0 0 -0.018 -0.03A0.177 0.177 0 0 1 0.02 0.205a0.145 0.145 0 0 1 0.278 -0.056 0.144 0.144 0 0 1 0.011 0.056zm-0.028 0a0.116 0.116 0 0 0 -0.233 0c0 0.071 0.061 0.102 0.061 0.139v0.031h0.111V0.344c0 -0.037 0.061 -0.068 0.061 -0.139M0.235 0.437a0.014 0.014 0 0 1 -0.014 0.014h-0.111a0.014 0.014 0 0 1 0 -0.028h0.111a0.014 0.014 0 0 1 0.014 0.014m-0.019 0.038a0.007 0.007 0 0 1 -0.002 0.008 0.08 0.08 0 0 1 -0.098 0 0.007 0.007 0 0 1 0.004 -0.013h0.089a0.007 0.007 0 0 1 0.007 0.005z"/></svg>,
};
